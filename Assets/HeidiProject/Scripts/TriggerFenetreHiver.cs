...
public class TriggerFenetreHiver : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (gameObject.GetComponent<HingeJoint>().angle <= 1 && birdIsInside == false && eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == false && automneFenetre.GetComponent<TriggerFenetreAutomne>().birdIsInside == false && printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == false)
        {
            //Activer le GameObject frameBirdEnter
            frameBirdEnter.SetActive(true);
            //Desactiver le GameObject animBirdEnter
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle > 10 && cocourtine == false && birdIsInside == false && eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == false && automneFenetre.GetComponent<TriggerFenetreAutomne>().birdIsInside == false && printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == false)
        {
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle >= 85 && cocourtine == true && birdIsInside == false && eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == false && automneFenetre.GetComponent<TriggerFenetreAutomne>().birdIsInside == false && printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == false)
        {
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle > 10 && cocourtine == false && (eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == true || automneFenetre.GetComponent<TriggerFenetreAutomne>().birdIsInside == true || printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == true))
        {
            // Apres 2 second lancer l'animation du bird
            co = StartCoroutine(StartAnimationOpen());
            cocourtine = true;
            birdIsInside = false;
        }// Si la fenetre n'est pas ouverte mais qu'il y a un bird inside alors arreter l'animation de la fermeture automatique de la fenetre et activer le scirpt XR Grab Interactable
        else if (gameObject.GetComponent<HingeJoint>().angle <= 1 && (eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == true || automneFenetre.GetComponent<TriggerFenetreAutomne>().birdIsInside == true || printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == true))
        {
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle >= 85 && cocourtine == true && (eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == true || automneFenetre.GetComponent<TriggerFenetreAutomne>().birdIsInside == true || printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == true))
        {
            ...
            {
                //jouer l'animation de ce gameobject une seule fois
                this.GetComponent<Animator>().enabled = true;
                hingeJoint.useMotor = false;
                //stop
                StopCoroutine(co);
