...
public class TriggerFenetreAutomne : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (gameObject.GetComponent<HingeJoint>().angle <= 1 && birdIsInside == false && hiverFenetre.GetComponent<TriggerFenetreHiver>().birdIsInside == false && eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == false && printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == false)
        {
            //Activer le GameObject frameBirdEnter
            frameBirdEnter.SetActive(true);
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle > 10 && cocourtine == false && birdIsInside == false && hiverFenetre.GetComponent<TriggerFenetreHiver>().birdIsInside == false && eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == false && printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == false)
        {
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle >= 85 && cocourtine == true && birdIsInside == false && hiverFenetre.GetComponent<TriggerFenetreHiver>().birdIsInside == false && eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == false && printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == false)
        {
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle > 10 && cocourtine == false && (hiverFenetre.GetComponent<TriggerFenetreHiver>().birdIsInside == true || eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == true || printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == true))
        {
            // Apres 2 second lancer l'animation du bird
            co = StartCoroutine(StartAnimationOpen());
            cocourtine = true;
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle <= 1 && (hiverFenetre.GetComponent<TriggerFenetreHiver>().birdIsInside == true || eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == true || printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == true))
        {
        ...
        else if (gameObject.GetComponent<HingeJoint>().angle >= 85 && cocourtine == true && (hiverFenetre.GetComponent<TriggerFenetreHiver>().birdIsInside == true || eteFenetre.GetComponent<TriggerFenetreEte>().birdIsInside == true || printempsFenetre.GetComponent<TriggerFenetrePrintemps>().birdIsInside == true))
        {
